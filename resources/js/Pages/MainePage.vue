            ...
            <div class="flex justify-center">
                <table>
                    ...
                    <tr v-for="(movie, index) in paginationMovies.data">
                        ...
                        <td class="py-2 px-4">
                            <router-link to="/createMovie" class="py-2.5 px-5 me-2 mb-2 text-sm font-medium text-gray-900 focus:outline-none bg-white rounded-lg border border-gray-200 hover:bg-gray-100 hover:text-blue-700 focus:z-10 focus:ring-4 focus:ring-gray-100 dark:focus:ring-gray-700 dark:bg-gray-800 dark:text-gray-400 dark:border-gray-600 dark:hover:text-white dark:hover:bg-gray-700">Info</router-link>
                        </td>
                        <td class="py-2 px-4 ">
                            <router-link to="/createMovie" class="py-2.5 px-5 me-2 mb-2 text-sm font-medium text-gray-900 focus:outline-none bg-white rounded-lg border border-gray-200 hover:bg-gray-100 hover:text-blue-700 focus:z-10 focus:ring-4 focus:ring-gray-100 dark:focus:ring-gray-700 dark:bg-gray-800 dark:text-gray-400 dark:border-gray-600 dark:hover:text-white dark:hover:bg-gray-700">Edit</router-link>
                        </td>
                        <td class="py-2 px-4">
                            <router-link to="/createMovie" class="focus:outline-none text-white bg-red-700 hover:bg-red-800 focus:ring-4 focus:ring-red-300 font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2 dark:bg-red-600 dark:hover:bg-red-700 dark:focus:ring-red-900">Delete</router-link>
                        </td>
                    </tr>
                </table>
            </div>
...
export default {
    setup() {
        ...
        return { paginationMovies, fetchPaginationData };
    },
};
</script>
